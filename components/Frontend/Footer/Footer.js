...
//               CareerCatch opens better and deserving opportunities for your
//               potential.
//             </p>
//             <div className="my-2">
//               <img
      ...
      <div className="container mt-5 pt-5">
        <div className="row pb-4">
          <div className="col-md-3 col-sm-12">
            <Link className="navbar-brand" href="/">
              <Image
                src="/media/img/CareerCatch.svg"
                alt="CareerCatch Website Logo"
                width={150}
                height={200}
              />
            </Link>
        ...
        <div className="row py-3">
          <div className="col-md-6">
            <p className="secondary-text fontSize14">
              Copyright © 2024. CareerCatch all right reserved
            </p>
          </div>
          <div className="col-md-6 text-md-end text-start">
            <Link
